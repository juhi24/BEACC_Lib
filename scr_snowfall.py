...
#brandes.plot(ax=ax2, label='Brandes 2007')
#plt.legend()
brandes.plot(ax=ax4, label='Brandes 2007', color='r')
plt.legend()

s = e.summary()
rho_d0 = read.PolFit(x=s.D_0_gamma, y=s.density)
rho_d0.find_fit()
rho_d0.plot(ax=ax4, label='fit')
